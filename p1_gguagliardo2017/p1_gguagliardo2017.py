...
class Checker(TwoPlayerGame):
    ...
    def make_move(self, pos):
        ...
        """Records the move the current player has made and saves it to the board"""            
    ...
    def lose(self):
       ...
       for x in self.players[1].pos:
            ...
            """
        code checks the position of the white and black pieces and compared them to their location in the black and white territories, 
        using the array_equal which returns true if two arrays have the same shape and elements
            """
